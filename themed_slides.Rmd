...
# 
# style_mono_accent_inverse(base_color = "#9596a3", 
#                           background_color = "#9596a3",
#                           text_color = "#000000", 
#                           header_color  ="#000000" )
...
hist <- fit_df5 %>% 
  ...
  scale_x_continuous(limits = c(-4,4)) + labs(y = "Density", x = "Residual", title = "Histogram")  #  #  theme_xaringan() +  +  
...
scale_y_continuous(limits = c(-4,4)) + labs(title = "QQ Plot of Residuals ", x = "Residual", y = "Expected") #  theme_xaringan() +  
```
