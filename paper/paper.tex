...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{military\_spending\_pct\_of\_gdp =} \KeywordTok{replace\_na}\NormalTok{(military\_spending\_pct\_of\_gdp, }\DecValTok{0}\NormalTok{), }
         \DataTypeTok{year =} \KeywordTok{as.numeric}\NormalTok{(year)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{murder\_per\_mil\_people =} \KeywordTok{replace}\NormalTok{(murder\_per\_mil\_people, country }\OperatorTok{==}\StringTok{ "Mexico"}\NormalTok{, }\FloatTok{29.07}\NormalTok{),}
...
\StringTok{         }\CommentTok{\# https://en.wikipedia.org/wiki/List\_of\_countries\_by\_intentional\_homicide\_rate}
\StringTok{         }\CommentTok{\# these murder rates were not included in the gapminder but i didnt want to }
\StringTok{         }\CommentTok{\# lose 3 important countries in LA}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{corruption\_perception\_index\_cpi =}\NormalTok{ (corruption\_perception\_index\_cpi }\OperatorTok{{-}}\StringTok{ }\DecValTok{100}\NormalTok{) }\OperatorTok{*}\StringTok{ }\DecValTok{{-}1}\NormalTok{) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
...
\NormalTok{outcome \textless{}{-}}\StringTok{ "polrights\_fh"}
...
\NormalTok{    model \textless{}{-}}\StringTok{ }\KeywordTok{as.formula}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(outcome, }\StringTok{" \textasciitilde{}"}\NormalTok{, }\KeywordTok{paste0}\NormalTok{(vc[,j], }\DataTypeTok{collapse =} \StringTok{" + "}\NormalTok{)))}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}
    \DataTypeTok{Model =} \KeywordTok{str\_replace\_all}\NormalTok{(model, }\StringTok{"\_"}\NormalTok{, }\StringTok{" "}\NormalTok{),}
