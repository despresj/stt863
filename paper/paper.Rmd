...
stargazer(fit_df6, fit_df5, fit_df4, type = "latex", 
                     ...
                     covariate.labels = c("Corruption Perception", "Education Expendature",
...
fit_df5 %>% 
  ...
  labs(y = "Density", x = "Residual", title = "Histogram") + 
...
fit_df5 %>% 
  ...
  stat_qq() +
  stat_qq_line(color = "#3C989E", size = 3) + 
scale_x_continuous(limits = c(-4,4)) + 
