...
- Corruption Perception Index ranges from 0 to 100 with 0 being the highest perception of corruption
...
kable(t2, align = "c") %>%
  kable_styling(full_width = FALSE, position = "left", html_font = "Cambria")
```
...
subsets %>% 
  ...
  geom_point() + 
  geom_smooth(data = r, aes(df, adj), se = FALSE, span = 0.5, color = "red") + 
