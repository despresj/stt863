...
* summarsze fh index
https://docs.google.com/spreadsheets/d/1AmmTVOAFMXZx3a-OYyKQaNM-dQJAvGCJOwfWzixo2Pk/edit#gid=266682269 
...
data %>% 
  ...
  ggplot() + 
  geom_bar(aes(x = polrights_fh)) + 
  geom_text(aes(x = polrights_fh, y = n, label = n)) + 
