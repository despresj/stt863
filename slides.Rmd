...
- **Murders rate** per million people
...
DT::datatable(fillContainer = FALSE, options = list(pageLength = 5), caption = "Mean", 
...
- Decided to keep them because they are indicating a substantial loss in political freedom which falls outside of the scope of the model. However, is important for our research question.
...
- The model does a much better job at predicting political freedom in countries with more. This is likely due to the fact that our sample is the OCED that skews twards more Political Freedom

---
# Conclusions

1. Despite minor problems with outliers we found that statistically significant 
1. because
